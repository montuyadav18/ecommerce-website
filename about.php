...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <p>Hey There ! I'm Montu Yadav. A Student of BSc IT is a Bachelor of Science in Information Technology Department from J.M.P.C College [Batch : 2024] . I love designing websites and exploring new things. Learning new things is my hobby.</p>

         <p>I would like to thank <a href="https://www.facebook.com/er.ashokbasnet" target="_blank">Mr. Ashish Shah</a> Sir for guiding me through the session and making me able to develop projects like this. </p>
...
<section class="reviews">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         <img src="images/dummy-user.png" alt="">
         <p>Shop Now India is great if you choose good sellers . A variety of required item available . Customers can return and refund full amount within 7 days easily . Shop Now India is boosting eCommerce business in Kathmandu.It provides great opportunity to sale items online with ease.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         <img src="images/dummy-user.png" alt="">
         <p>Using Shop Now India for online shopping from almost 3 years. Outstanding experience with them. Game vouchers and pick up point as delivery with 0 shipping charges are super saving services.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
      ...
      <div class="swiper-slide slide">
         <img src="images/dummy-user.png" alt="">
         <p>Shop Now India is cool! I have ordered hundreds of products from it and never got any scam. It delivers products in time with out delay. Packaging of products are strong and delivery rates are too low. Just amazing Website will keep shopping from Shop Now India.</p>
         <div class="stars">
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
            <i class="fas fa-star"></i>
