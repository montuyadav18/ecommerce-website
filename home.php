...
<head>
   ...
   <title>Shop Now India.Com</title>
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            ...
            <a href="category.php?category=laptop" class="btn">Shop Now.</a>
         </div>
      </div>
...
<section class="category"  style="max-width:1300px">

   <h1 class="heading" style="color:#fff">Shop by Category</h1>
